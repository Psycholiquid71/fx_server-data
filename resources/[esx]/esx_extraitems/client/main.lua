...
--[[RegisterNetEvent('esx_extraitems:energybar')
AddEventHandler('esx_extraitems:energybar', function(prop_name)
...
--[[RegisterNetEvent('esx_extraitems:energybar')
AddEventHandler('esx_extraitems:energybar', function()
  ...
  AttachEntityToEntity(prop, playerPed, boneIndex, 0.12, 0.028, 0.001, 10.0, 175.0, 0.0, true, true, false, true, 1, true)
        ...
        RequestAnimSet("mp_player_inteat@burger") 
    while not HasAnimSetLoaded("mp_player_inteat@burger") do
      Citizen.Wait(0)
    end    

    --TaskStartScenarioInPlace(playerPed, "mp_player_int_eat_burger_fp", 0, 1)
    Citizen.Wait(3000)
    ClearPedTasksImmediately(playerPed)
    SetTimecycleModifier("spectator5")
    SetPedMotionBlur(playerPed, true)
    SetPedMovementClipset(playerPed, "mp_player_int_eat_burger_fp", true)
