...
local screenPosX = 0.157                    -- X coordinate (top left corner of HUD)
local screenPosY = 0.892                    -- Y coordinate (top left corner of HUD)
...
-- SEATBELT PARAMETERS
local seatbeltInput = 47                   -- Toggle seatbelt on/off with G
...
local cruiseInput = 20                     -- Toggle cruise on/off with Z or A button (controller)
