Locales['en'] = {
  ...
  ['open_cloackroom'] = 'Press ~INPUT_PICKUP~ to change ~y~clothes~s~.',
  -- Armory
  ...
  ['armory'] = 'armory',
  ['open_armory'] = 'Press ~INPUT_PICKUP~to access the ~y~Armory~s~.',
  ['armory_owned'] = 'owned',
  ['armory_free'] = 'free',
  ['armory_item'] = '$%s',
  ...
  -- Evidence
  ['remove_e_object'] = 'withdraw evidence object',
  ['deposit_e_object'] = 'deposit evidence object',
  ['get_e_weapon'] = 'withdraw weapon from evidence',
  ['put_e_weapon'] = 'store weapon in envidence',
  ['evidence'] = 'evidence',
  ['open_evidence'] = 'Press ~INPUT_PICKUP~to access the ~y~Evidence Locker~s~.',
  ['evidence_item'] = '$%s',
  ['get_e_weapon_menu'] = 'evidence - Withdraw Weapon',
  ['put_e_weapon_menu'] = 'evidence - Store Weapon',
  -- Vehicles
  ['vehicle_menu'] = 'vehicle',
  ['vehicle_blocked'] = 'all available spawn points are currently blocked!',
  ['garage_prompt'] = 'Press ~INPUT_PICKUP~ to access the ~y~Vehicle Actions~s~.',
  ...
  ['helicopter_prompt'] = 'Press ~INPUT_PICKUP~ to access the ~y~Helicopter Actions~s~.',
  ...
  ['impound_prompt'] = 'Press ~INPUT_PICKUP~ to cancel the ~y~impound~s~',
  ...
  -- Misc
  ['remove_prop'] = 'Press ~INPUT_PICKUP~ to delete the object',
