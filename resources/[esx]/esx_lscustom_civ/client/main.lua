...
AddEventHandler('esx:playerLoaded', function(xPlayer)
	PlayerData = xPlayer
	ESX.TriggerServerCallback('esx_lscustom_paintingonly:getVehiclesPrices', function(vehicles)
		Vehicles = vehicles
	end)
end)
...
RegisterNetEvent('esx_lscustom_paintingonly:installMod')
AddEventHandler('esx_lscustom_paintingonly:installMod', function()
	local vehicle = GetVehiclePedIsIn(PlayerPedId(), false)
	myCar = ESX.Game.GetVehicleProperties(vehicle)
	TriggerServerEvent('esx_lscustom_paintingonly:refreshOwnedVehicle', myCar)
end)

RegisterNetEvent('esx_lscustom_paintingonly:cancelInstallMod')
AddEventHandler('esx_lscustom_paintingonly:cancelInstallMod', function()
	local vehicle = GetVehiclePedIsIn(PlayerPedId(), false)
...
function OpenLSMenu(elems, menuName, menuTitle, parent)
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), menuName,
	{
		...
		for k,v in pairs(Config.Menus) do
			...
			if k == data.current.modType or isRimMod then
				...
				if data.current.label == _U('by_default') or string.match(data.current.label, _U('installed')) then
					...
					TriggerEvent('esx_lscustom_paintingonly:installMod')
				else
					...
					if isRimMod then
						...
						TriggerServerEvent("esx_lscustom_paintingonly:buyMod", price)
		...
		menu.close()
		TriggerEvent('esx_lscustom_paintingonly:cancelInstallMod')
