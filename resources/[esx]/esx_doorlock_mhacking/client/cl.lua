...
AddEventHandler('esx_doorlock:currentlyhacking', function(mycb)
			...
			TriggerEvent("mhacking:start",5,30,mycb1) --This line is the difficulty and tells it to start. First number is how long the blocks will be the second is how much time they have is.
end)
