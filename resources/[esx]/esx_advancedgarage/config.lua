...
Config.CarGarages = {
	...
	Garage_PinkCage = {
		GaragePoint = { x = 276.65, y = -346.85, z = 43.92 },
		SpawnPoint = { x = 289.76, y = -337.63, z = 44.92, h = 155.19 },
		DeletePoint = { x = 270.97, y = -343.11, z = 43.92 }
	},
	Garage_Sandy = {
	...
	Garage_Prison = {
		GaragePoint = { x = 1831.56, y = 2542.09, z = 44.88 },
		SpawnPoint = { x = 1833.41, y = 2542.05, z = 45.88, h = 269.1 },
		DeletePoint = { x = 1836.26, y = 2542.01, z = 44.46 } -- z = 44.67
	},
	Garage_Moab = {
		GaragePoint = { x = 5077.82, y = -569.86, z = 52.99 },
		SpawnPoint = { x = 5039.54, y = -558.74, z = 50.56, h = 281.65 },
		DeletePoint = { x = 5099.49, y = -543.08, z = 52.7 }
	},
	Garage_RaceTrack = {
