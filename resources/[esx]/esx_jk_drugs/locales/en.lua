Locales ['en'] = {
  ...
  ['weed_processed'] = 'You are processing ~g~Cannabis~s~ to ~g~Marijuana~s~',
  ...
  ['cocaine_processed'] = 'You are processing ~g~CocaPlant~s~ to ~g~Cocaine~s~',
  ...
  ['ephedrine_processed'] = 'You are processing ~g~Ephedra~s~ to ~g~Ephedrine~s~',
  ...
  ['meth_processed'] = 'You are processing ~g~Ephedrine~s~ to ~g~Meth~s~',
  ...
  ['crack_processed'] = 'You are processing ~g~Cocaine~s~ to ~g~Crack~s~',
  ...
  ['opium_processed'] = 'You are processing ~g~Poppy~s~ to ~g~Opium~s~',
  ...
  ['heroine_processed'] = 'You are processing ~g~Opium~s~ to ~g~Heroine~s~',
  ...
  ['restricted_zone'] = 'Entering private property.'
}
