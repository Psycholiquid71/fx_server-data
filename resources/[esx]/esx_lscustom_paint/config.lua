...
Config.Zones = {
	...
	ls1 = { -- south of city, near airport
		Pos   = { x = -1167.27, y = -2013.43, z = 12.14},
	...
	ls2 = { -- near legion
		Pos   = { x = 735.86, y = -1071.69, z = 21.23},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls3 = { -- sandy
		Pos   = { x = 1182.34, y = 2637.25, z = 36.82},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls4 = { -- paleto
		Pos   = { x = 102.83, y = 6623.69, z = 30.89},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
