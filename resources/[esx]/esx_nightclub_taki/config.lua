...
Config.Zones = {
    ...
    Vehicles = {
        Pos          = { x = -556.19, y = 297.25, z = 82.08 },
        SpawnPoint   = { x = -551.6, y = 304.72, z = 82.21 },
    ...
    Helicopters = {
        ...
        Pos          = { x = -581.79, y = 278.5 , z = 93.09 },
        SpawnPoint   = { x = -576.49, y = 285.62, z = 93.09 },
        Size         = { x = 1.8, y = 1.8, z = 1.0 },
        Color        = { r = 255, g = 255, b = 0 },
        Type         = 23,
        Heading      = 350.54,
...
Config.TeleportZones = {
  ...
  EnterHeliport = {
    Pos       = { x = -562.07, y = 292.42, z = 86.58 },
    Size      = { x = 2.0, y = 2.0, z = 0.2 },
    Color     = { r = 204, g = 204, b = 0 },
    Marker    = 1,
    Hint      = _U('e_to_enter_2'),
    Teleport  = { x = -573.2, y = 278.17, z = 93.09 }
  },

  ExitHeliport = {
    Pos       = { x = -581.36, y = 292.29, z = 93.09 },
    Size      = { x = 2.0, y = 2.0, z = 0.2 },
    Color     = { r = 204, g = 204, b = 0 },
    Marker    = 1,
    Hint      = _U('e_to_exit_2'),
    Teleport  = { x = -562.1, y = 294.91, z = 86.49 },
  },
}
