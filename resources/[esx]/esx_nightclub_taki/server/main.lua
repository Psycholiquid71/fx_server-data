...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'nightclub_taki', Config.MaxInService)
end

TriggerEvent('esx_society:registerSociety', 'nightclub_taki', 'Nightclub Takilala', 'society_nightclub_taki', 'society_nightclub_taki', 'society_nightclub_taki', {type = 'private'})
...
AddEventHandler('esx_nightclub:getStockItem', function(itemName, count)
	...
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_nightclub_taki', function(inventory)
...
AddEventHandler('esx_nightclub:getFridgeStockItem', function(itemName, count)
	...
	local xPlayer = ESX.GetPlayerFromId(_source)
	local sourceItem = xPlayer.getInventoryItem(itemName)
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_nightclub_taki_fridge', function(inventory)
...
AddEventHandler('esx_nightclub:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_nightclub_taki', function(account)
...
ESX.RegisterServerCallback('esx_nightclub:getVaultWeapons', function(source, cb)
  ...
  TriggerEvent('esx_datastore:getSharedDataStore', 'society_nightclub_taki', function(store)
...
--Phone
TriggerEvent('esx_phone:registerNumber', 'nightclub_taki', _U('alert_nightclub_taki'), true, true)

AddEventHandler('onResourceStop', function(resource)
	if resource == GetCurrentResourceName() then
		TriggerEvent('esx_phone:removeNumber', 'nightclub_taki')
	end
end)