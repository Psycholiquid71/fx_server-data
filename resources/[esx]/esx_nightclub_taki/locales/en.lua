Locales['en'] = {
    ...
    ['nightclub_taki_fridge_stock']   = 'Fridge of the Takilala Nightclub',
    ['fridge_inventory']         = 'Content of the fridge',
  
    -- Shops  
    ['shop']                     = 'Takilala Nightclub Shop',
    ...
    ['quantity']                 = 'Amount',
    ['inventory']                = 'Inventory',
    ['nightclub_taki_stock']          = 'Stock from the Takilala Nightclub',
    ...
    -- Phone  
    ['nightclub_taki_phone']            = 'Nightclub',
    ['nightclub_taki_customer']         = 'Citizen',
    ['alert_nightclub_taki']         = 'Issue at Takilalas',
