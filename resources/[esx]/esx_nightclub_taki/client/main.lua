...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'nightclub_taki' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'nightclub_taki', vehicleProps)
...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'nightclub_taki_actions',
    {
      title    = _U('nightclub_taki'),
      align    = 'bottom-right',
      elements = elements
    },
    function(data, menu)
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil or amount < 0 then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_nightclub_taki', _U('billing'), amount)
        end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_nightclub:getFridgeStockItems', function(items)
    ...
    ESX.UI.Menu.Open(
      ...
      {
        title    = _U('nightclub_taki_fridge_stock'),
		align    = 'bottom-right',
        elements = elements
      },
      function(data, menu)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'nightclub_taki_shop',
        {
            title    = _U('shop'),
			align    = 'bottom-right',
            elements = elements
...
Citizen.CreateThread(function()
  while true do
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'nightclub_taki', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'nightclub_taki')
            end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:openBossMenu', 'nightclub_taki', function(data, menu)
    ...
    if IsControlJustReleased(0,  Keys['F6']) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'nightclub_taki_actions') then
...
AddEventHandler('esx_phone:loaded', function(phoneNumber, contacts)
	local specialContact = {
	     name       = _U('phone_nightclub_taki'),
	     number     = 'nightclub_taki',
...
AddEventHandler('onResourceStop', function(resource)
	if resource == GetCurrentResourceName() then
		TriggerEvent('esx_phone:removeSpecialContact', 'nightclub_taki')
	end	
end)
