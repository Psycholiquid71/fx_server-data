TokoVoipConfig = {
	...
	plugin_data = {
		...
		TSChannel = "In_Game",
		TSPassword = "password", -- TeamSpeak channel password (can be empty)
		...
		TSChannelWait = "Standby_Channel",

		-- Blocking screen informations
		TSServer = "homebase-networks.asuscomm.com", -- TeamSpeak server address to be displayed on blocking screen
