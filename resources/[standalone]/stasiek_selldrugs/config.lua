...
Config.SellOpiu = true	-- if true, players can sell heroine
Config.WeedPrice = 5	-- sell price for single, not pooch (black money)
Config.MethPrice = 8	-- sell price for single, not pooch (black money)
Config.CokePrice = 11	-- sell price for single, not pooch (black money)
Config.OpiuPrice = 12	-- sell price for single, not pooch (black money)
