...
AddEventHandler('sellDrugs', function()
	...
	local opiuqty = xPlayer.getInventoryItem('heroine').count
	...
	TriggerClientEvent('esx:showNotification', _source, _U('you_have_sold') .. '~b~'..x..'~w~ of '.. _U(drugType) ..' for ' .. blackMoney .. '$')
end)
