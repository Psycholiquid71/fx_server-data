...
--Hospital--
Config.EnableHospital             = true    -- If true spawn Hospital Interior NPCs
--Hospital--
...
Config.Locations23 = { --Hospital Staff Reeception
	{ x = 308.42, y = -597.1, z = 42.29, heading = 358.06 }

}

Config.Locations24 = { --Hospital Staff Nursing
	{ x = 326.2, y = -583.3, z = 42.32, heading = 359.62 },
	

}

Config.Locations25 = { --Hospital Staff Surgery
	--{ x = 365.55, y = -593.18, z = 43.39, heading = 63.03 }
	{ x = 365.55, y = -593.18, z = 42.39, heading = 63.03 } -- Plastic Surgeon

}

Config.Locations26 = { --Hospital Gift Shop
	{ x = 316.44, y = -587.19, z = 42.32, heading = 200.2 }
